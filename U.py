...
uLUT.RGBPoints = [4.7709398674465147e-08, 0.231373, 0.298039, 0.752941, 0.038694414911077536, 0.865003, 0.865003, 0.865003, 0.07738878211275639, 0.705882, 0.0156863, 0.14902]
uLUT.ScalarRangeInitialized = 1.0

# get opacity transfer function/opacity map for 'U'
uPWF = GetOpacityTransferFunction('U')
uPWF.Points = [4.7709398674465147e-08, 0.0, 0.5, 0.0, 0.07738878211275639, 1.0, 0.5, 0.0]
uPWF.ScalarRangeInitialized = 1

# trace defaults for the display properties.
reflect1Display.Representation = 'Surface'
reflect1Display.ColorArrayName = ['POINTS', 'U']
reflect1Display.LookupTable = uLUT
...
reflect1Display.ScalarOpacityFunction = uPWF
