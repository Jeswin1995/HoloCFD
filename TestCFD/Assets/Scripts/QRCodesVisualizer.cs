...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
        ...
        public GameObject updatePoseObject;
            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        updatePoseObject.GetComponent<SpatialGraphCoordinateSystem>().Id = action.qrCode.SpatialGraphNodeId;
                        qrCodeObject.GetComponent<QRCode>().qrCode = action.qrCode;
                        updatePoseObject.GetComponent<QRCode>().qrCode = action.qrCode;
